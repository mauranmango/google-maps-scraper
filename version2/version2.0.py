...
class GoogleMapsCrawler:
    ...
    def create_df_and_populate_from_extracted_data(self, all_reviews):
        ...
        for review in all_reviews:
            ...
            rating = len(review.find_all("img", class_="hCCjke vzX5Ic"))
            review_time_information = review.find("span", class_="rsqaWe").text
        ...
        df.to_csv("..\\version2.0.csv")  # FIXME  save to your own location


if __name__ == "__main__":
    scraper = GoogleMapsCrawler()
    url = "https://www.google.com/maps/place/Caf%C3%A9+Was+Gesundes/@52.5003887,13.2941771,17z/data=!3m1!5s0x47a850c3511e0265:0x86c37535b33f6754!4m17!1m11!3m10!1s0x47a850c4b634ef93:0x2faf0f02eacd864e!2sAspria+Berlin+Ku%E2%80%99damm!5m2!4m1!1i2!8m2!3d52.5003887!4d13.2941771!9m1!1b1!3m4!1s0x47a8514c12e2f661:0x357e3c0ec55e6716!8m2!3d52.5006922!4d13.2968284"  # TODO change to the url you want
